...
In addion to this, our residual variance for our totalcountry_lm is 7.62. when you then divide 7.62 over 8.25 = 92.36. This is the amount of unexplained variability in Murders that is not accounted for by SDI in the model. As you can see, this is the same as we got above with the R-squared value. This indicates that the model is doing a poor job of explaining the variability in the response variable.
