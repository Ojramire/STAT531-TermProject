...
data_clean |>
  ...
  labs(x = "Sustainable Development Index (SDI)", 
       ...
       title = "Relationship between SDI and Murder Rate per 100k for 5 Countries",
       caption = "Figure 1. ") +
...
We used a simple linear regression to plot the correlation between the Sustainable Development Index and Murder Rate per 100K for each of the five countries both individually and in conjunction. 
...
$$
For the US data, every unit increase in Sustainable Development Index results in a 0.2016 increase in murder rate.  Based on the intercept, with a SDI of 0, the murder rate would be around 2.5978 per 100k people.
...
$$
For the Germany  data, every unit increase in Sustainable Development Index results in a 0.04798 increase in murder rate.  Based on the intercept, with a SDI of 0, the murder rate would be around negative 2.08016 per 100k people, which is of course an  impossible value.
Singapore Regression Equation
$$
\hat{y}_{Murder Rate}=0.02891 x_{SDI}-0.28529
$$
For the Singapore data, every unit increase in Sustainable Development Index results in a 0.02891 increase in murder rate.  Based on the intercept, with a SDI of 0, the murder rate would be around -0.28529 per 100k people, which is of course.
Japan Regression Equation
$$
\hat{y}_{Murder Rate}=0.005984x_{SDI}-0.231561
$$
For the Japan data, every unit increase in Sustainable Development Index results in a 0.005984 increase in murder rate.  Based on the intercept, with a SDI of 0, the murder rate would be around -0.231561 per 100k people, which again is impossible.
### Model Fit
```{r}
library(broom)
