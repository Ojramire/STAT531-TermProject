...
total_resid <- totalcountry_lm %>% 
  augment() %>% 
  ggplot(aes(x=.fitted, y=.resid))+
  geom_point()+
  geom_hline(yintercept=0, linetype=2)+
  scale_y_continuous(limits=c(-8, 8))+
  labs(x="Fitted Values", y="", subtitle="Residuals", title="All Countries")
...
us_resid <- us_lm %>% 
  ...
  labs(x="Fitted Values", y="", subtitle="Residuals", title="United States")

australia_resid <- australia_lm %>% 
  augment() %>% 
  ggplot(aes(x=.fitted, y=.resid))+
  geom_point()+
  geom_hline(yintercept=0, linetype=2)+
  scale_y_continuous(limits=c(-0.5, 0.5))+
  labs(x="Fitted Values", y="", subtitle="Residuals", title="Australia")

germany_resid <- germany_lm %>% 
  augment() %>% 
  ggplot(aes(x=.fitted, y=.resid))+
  geom_point()+
  geom_hline(yintercept=0, linetype=2)+
  scale_y_continuous(limits=c(-0.3, 0.3))+
  labs(x="Fitted Values", y="", subtitle="Residuals", title="Germany")

singapore_resid <- singapore_lm %>% 
  augment() %>% 
  ggplot(aes(x=.fitted, y=.resid))+
  geom_point()+
  geom_hline(yintercept=0, linetype=2)+
  scale_y_continuous(limits=c(-0.5, 0.5))+
  labs(x="Fitted Values", y="", subtitle="Residuals", title="Singapore")

japan_resid <- japan_lm %>% 
  augment() %>% 
  ggplot(aes(x=.fitted, y=.resid))+
  geom_point()+
  geom_hline(yintercept=0, linetype=2)+
  scale_y_continuous(limits=c(-0.2, 0.2))+
  labs(x="Fitted Values", y="", subtitle="Residuals", title="Japan")
